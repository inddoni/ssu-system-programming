...
public class Assembler {
    ...
    public Assembler(String instFile) {
        ...
        instTable.openFile(instFile);
        instTable.setInstruction();
        //instTable.printInstMap();
    ...
    private void loadInputFile(String inputFile) {
        ...
        inputTable = new InstTable(inputFile);
        inputTable.openFile(inputFile);
        lineList = inputTable.getLines();
    ...
    private void pass1(){
        ...
        for(String line : lineList){
            if(line.contains("START") || line.contains("CSECT")){
                section++;
                //SymbolTable cpySymbolTab = (SymbolTable)symbolTables[section].clone();
                //LiteralTable cpyLiteralTab = (LiteralTable)literalTables[section].clone();
